...
```toml
[dependencies]
lis2dux12-rs = { version = "2.0.0", default-features = false, features = ["blocking"] }
```
or from the terminal:
```sh
cargo add lis2dux12-rs --no-default-features --features blocking
```
...
More details and instructions are available in [bsp/README.md](https://github.com/STMicroelectronics/lis2dux12-rs/blob/main/bsp/README.md).
