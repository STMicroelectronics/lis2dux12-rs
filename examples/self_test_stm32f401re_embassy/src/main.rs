...
use lis2dux12_rs::prelude::*;
use lis2dux12_rs::{Error, I2CAddress, Lis2dux12, ID};
...
async fn main(_spawner: Spawner) {
    ...
    let mut sensor = Lis2dux12::new_i2c(i2c, I2CAddress::I2cAddH, delay.clone());
