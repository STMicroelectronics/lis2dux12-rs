# LIS2DUX12 Embedded Step Counter on STM32F401RE Nucleo-64 Using Embassy Framework

This example demonstrates how to use the **LIS2DUX12** accelerometer sensor's embedded step counter feature on an **STM32F401RE** microcontroller board. The sensor is configured to detect steps and output the step count over UART.
...
- **Sensor:** LIS2DUX12 Accelerometer with embedded step counter
...
The LIS2DUX12 sensor is connected via I2C1 on PB8/PB9. The step detection interrupt line is connected to PB0, configured to trigger an external interrupt on rising edge. UART output is routed through PA2.
...
*This README explains the embedded Rust program for embedded step counting on the LIS2DUX12 sensor using STM32F401RE and the Embassy framework.*
