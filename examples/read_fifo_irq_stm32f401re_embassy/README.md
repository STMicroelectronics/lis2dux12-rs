# LIS2DUX12 FIFO Data Streaming on STM32F401RE Nucleo-64 Using Embassy Framework
...
*This README explains the embedded Rust program for FIFO-based accelerometer data streaming on the LIS2DUX12 sensor using STM32F401RE and the Embassy framework.*
