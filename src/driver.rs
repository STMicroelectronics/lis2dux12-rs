...
#[bisync]
impl<B, T> Lis2dux12<B, T, MainBank>
where
    B: BusOperation,
    T: DelayNs,
{
    ...
    /// # Returns
    ///
    /// - `Result<Lis2dux12<B, T, EmbBank>, Error<B::Error>>`
    ///     - `Lis2dux12<B, T, EmbBank>`: The sensor in the EmbBank state
    ///     - `Error<B::Error>`: Error during the MemBank switch
    pub async fn switch_to_emb(mut self) -> Result<Lis2dux12<B, T, EmbBank>, Error<B::Error>> {
...
#[bisync]
impl<B, T> Lis2dux12<B, T, EmbBank>
where
    B: BusOperation,
    T: DelayNs,
{
    ...
    /// # Returns
    ///
    /// - `Result<Lis2dux12<B, T, MainBank>, Error<B::Error>>`
    ///     - `Lis2dux12<B, T, MainBank>`: The sensor in the EmbBank state
    ///     - `Error<B::Error>`: Error during the membank switch
    pub async fn switch_to_main(mut self) -> Result<Lis2dux12<B, T, MainBank>, Error<B::Error>> {
...
#[bisync]
impl<B: BusOperation, T: DelayNs> Lis2dux12<B, T, EmbBank> {
    /// Retrieves the number of detected steps from the step counter.
    ///
    /// # Returns
    ///
